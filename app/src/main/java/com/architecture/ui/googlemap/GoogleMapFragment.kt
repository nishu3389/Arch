package com.architecture.ui.googlemap
...
import com.architecture.databinding.FragmentGoogleMapBinding
import com.architecture.util.ParcelKeys
import com.architecture.util.location.GPSTracker
    ...
    OnCameraIdleListener
{
    ...
    override fun onCreateView(
        ...
        getParcelAndConsume(R.id.GoogleMapFragment) {
            ...
            var responseItemDetail=it.getSerializable(ParcelKeys.PK_LOCATION_DETAIL)
