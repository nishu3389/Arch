package com.raykellyfitness.util.Fusedlocation
...
import com.raykellyfitness.util.AlertDialogUtils
    ...
    private fun isGPSOn() {
        ...
        if (!gps_enabled && !network_enabled) {
            ...
            AlertDialogUtils.showDialog(
                mContext,
                "",
                mContext.getString(com.raykellyfitness.R.string.gps_network_not_enabled),
                mContext.getString(com.raykellyfitness.R.string.open_location_settings),
                mContext.getString(com.raykellyfitness.R.string.Cancel),
                this
            )
        }
    }
