...
class HomeViewModel(controller: AsyncViewController) : BaseViewModel(controller) {
    ...
    fun callAdvApi() : MutableLiveData<MasterResponse<AdvlistResponse>>{
        responseAdv = MutableLiveData<MasterResponse<AdvlistResponse>>()
        baseRepo.restClient.callApi(Api.ADVERTISEMENTS, null, responseAdv!!)
        return responseAdv as MutableLiveData<MasterResponse<AdvlistResponse>>
    }
