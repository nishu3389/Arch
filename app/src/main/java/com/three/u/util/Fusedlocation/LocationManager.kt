...
import com.three.u.util.AlertDialogUtils
    ...
    private fun isGPSOn() {
        ...
        if (!gps_enabled && !network_enabled) {
            ...
            AlertDialogUtils.showDialog(
                mContext,
                "",
                mContext.getString(com.three.u.R.string.gps_network_not_enabled),
                mContext.getString(com.three.u.R.string.open_location_settings),
                mContext.getString(com.three.u.R.string.Cancel),
                this
            )
        }
    }
